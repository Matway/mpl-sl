...
{dst: 0nx;          } () {} "JSONDestroy" importFunction
{dst: 0nx; src: 0nx;} () {} "JSONSet"     importFunction
{dst: 0nx;          } () {} "JSONInit"    importFunction
...

{
  ...
  padding: Int32;
  result: String Ref;
} () {} "catJSONNodeWithPadding" importFunction
